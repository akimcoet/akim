...
echo "\n";
echo "\e[96m            ( ABANG AKIM $input)               \n";
echo "\e[89m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n";
echo color("green","# # # # # # # # # # # # # # # # # # # # # # # \n");
echo color("blue","[•] BOJOKU BAKUL YAKULT PODO TUKUO \n");
...
// function change(){
        ...
        echo color("green"," Kode wis di kirim ....")."\n";
        otp:
        echo color("purple"," Anjingna otp ne.. : ");
        $otp = trim(fgets(STDIN));
        $data1 = '{"client_name":"gojek:cons:android","data":{"otp":"' . $otp . '","otp_token":"' . $otptoken . '"},"client_secret":"8ma6fb55-f507-4273-9069-9d555e79ea1d"}';
        $verif = request("/v5/customers/phone/verify", null, $data1);
        if(strpos($verif, '"access_token"')){
        echo color("green"," Alhamdulillah manjing..\n");
        $token = getStr('"access_token":"','"',$verif);
        $uuid = getStr('"resource_owner_id":',',',$verif);
        echo color("nevy","+] Your access token : ".$token."\n\n");
        save("token.txt",$token);
        echo color("green","\n▬▬▬▬▬▬▬▬▬▬▬▬🛠 GAYA HIDUP SEHAT 🛠▬▬▬▬▬▬▬▬▬▬▬▬");
        echo "\n".color("blue","MINUM YAKULT..");
        echo "\n".color("yellow"," tiga kali sehari.... Skip");
        for($a=1;$a<=3;$a++){
        echo color("yellow",".");
        sleep(20);
        }
        ...
        echo "\n".color("red","🔐▶️ Message: ".$message);
	      gocar:
        echo "\n".color("blue","SAYANGI ISTRI...");
        echo "\n".color("yellow"," uhhhuhhhuuuuhhh..");
        for($a=1;$a<=3;$a++){
        echo color("yellow",".");
        sleep(20);
        }
        ...
        echo "\n".color("red","🔐▶️ Message: ".$message);
        gofood:
        echo "\n".color("blue","SANTUNI JANDA");
        echo "\n".color("yellow","sing enom tapi...");
        for($a=1;$a<=3;$a++){
        echo color("yellow",".");
        sleep(10);
        }
        ...
        $TOKEN  = "1";
         ...
         setpin:
         echo "\n".color("green"," PINE SISAN BEN AMAN !!!: y/n ");
         ...
         echo color("red","-] YAKULT wis enteng..");
         echo"\n▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n\n";
         echo color("green","!] belanja maning\n");
         goto otp;
         }
         }else{
         echo color("red","-] Pada Lanange");
         echo"\n▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n\n";
         echo color("green","!] Silahkan Golet sing Wedo\n");
         }
//  }
